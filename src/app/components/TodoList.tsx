...
import { useCopilotAction, useCopilotReadable } from "@copilotkit/react-core"; // Importing the useCopilotAction and useCopilotReadable hooks
...
export const TodoList: React.FC = () => {
  ...
  // Add Copilot actions and readables
  useCopilotReadable({
